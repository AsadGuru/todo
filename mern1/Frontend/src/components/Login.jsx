                ...
                <div className="px-6 h-full text-gray-800">
                    <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                        <div className="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0">
                            <img src="https://img.freepik.com/premium-photo/notebook-with-top-top-it-that-says-top-it_955834-45571.jpg?size=626&ext=jpg&ga=GA1.1.1112786753.1725246199&semt=ais_hybrid" className="w-full" alt="Sample" />
                        </div>
                            ...
                            <form method='post' onSubmit={handleSubmit}>
                                ...
                                <div className="text-center lg:text-left">
                                    ...
                                    <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                                        ...
                                        <Link
                                            to={"/register"}
                                            className="text-black-600 hover:text-black-700 focus:text-red-700 transition duration-200 ease-in-out"
                                        >Register</Link>
                                    </p>
                                </div>
                            </form>
